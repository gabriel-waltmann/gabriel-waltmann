context("index", () => {
  ...
  it("should have header elements" , () => {    
    ...
    cy.get("header ul li a[href='mailto:gabrielwaltmann@gmail.com']")
      .should("be.visible")

    cy.log("has instagram link element");
    cy.get("header ul li a[href='https://www.instagram.com/waltmanngabriel']")
      .should("be.visible")

    cy.log("has github link element");
    cy.get("header ul li a[href='https://github.com/gabriel-waltmann']")
      .should("be.visible")
